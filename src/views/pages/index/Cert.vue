...
const tabItems = ['资质证书', '实验室环境', '合作客户']
const navigationTab2 = ref('资质证书')
...
<template>
  <VRow>
    ...
    >
        ...
        >
          <VContainer id="features">
            <div>
              <VRow>
                <VCol
                  v-for="(data, index) in cooperators"
                  :key="index"
                  cols="12"
                  md="3"
                >
      ...
      <VCardActions class="justify-center feature-cards">
