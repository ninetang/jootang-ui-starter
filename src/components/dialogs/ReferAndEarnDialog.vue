      ...
      <VCardText class="pt-5">
        <div class="text-center pb-3">
          ...
          <div class="text-body-1">
            Invite your friend to JooTang, if they sign up, you and your friend will get 30 days free trial
          </div>
        </div>
        ...
        <p class="mb-2">
          Enter your friend's email address and invite them to join JooTang 😍
        </p>
        <VForm
